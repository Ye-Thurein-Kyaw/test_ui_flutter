...
class WhiteContainerThreeColumnWidget extends StatelessWidget {
  ...
  const WhiteContainerThreeColumnWidget(
      {Key? key,
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            columnItem(thirdText, thirdIcon, thirdOnTap),
          ],
        ),
      ),
    );
